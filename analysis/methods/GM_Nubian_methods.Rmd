...
save(core_lms, file = "../methods/data/derived_data/core_lms.RData")
...
save(alloutline, file = "../methods/data/derived_data/alloutline.RData")
```
...
allpatched <- placePatch(atlas = core_atlas, dat.array = alloutline, path = "../methods/data/raw_data/core_data", inflate = 7, fileext = ".ply")
```
...
save(allpatched, file = "../methods/data/derived_data/allpatched.RData")
```
...
save(patchedNK, file = "../methods/data/derived_data/patchedNK.RData")

# Extract specimens 116-166 into "patchedTH"
patchedTH <- allpatched[, , 116:166]
save(patchedTH, file = "../methods/data/derived_data/patchedTH.RData")

# Extract specimens 1-115 into "prefNK"
prefNK <- allprefs[, , 1:115]
save(prefNK, file = "../methods/data/derived_data/prefNK.RData")

# Extract specimens 116-166 into "prefTH"
prefTH <- allprefs[, , 116:166]
save(prefTH, file = "../methods/data/derived_data/prefTH.RData")
...
# Save the new semilandmark array for ease of future use
save(prod_lms, file = "../methods/data/derived_data/prod_lms.RData")
...
slide_curves <- slider3d(prod_lms, SMvector = fix, deselect = TRUE, outlines = outlines,
                            sur.path = "../methods/data/raw_data/product_data", sur.type = "ply", iterations = 3)
...
save(prod_outline, file = "../methods/data/derived_data/prod_outline.RData")
```
...
prod_temp <- as.matrix(read.table("../methods/data/derived_data/PointME78.1017.4_LRtemplate.pts", skip = 2, header = F)[,2:4])
...
prod_patched <- placePatch(atlas = prod_atlas, dat.array = prod_outline, path = "../methods/data/raw_data/product_data", inflate = 5, fileext = ".ply")
```
...
# Save the patched slm data
save(prod_patched, file = "../methods/data/derived_data/prod_patched.RData")
...
save(prod_ventr, file = "../methods/data/derived_data/prod_ventr.RData")
```
...
pts <- read.csv("../methods/data/derived_data/File_list_prods.csv")
...
load("../methods/data/derived_data/allpatched.RData")
load("../methods/data/derived_data/alloutline.RData")
load("../methods/data/derived_data/allprefs.RData")

# Import the attribute data for cores and read attributes as Factors
cores <- read.csv("../methods/data/derived_data/File_list_cores.csv", header=TRUE, stringsAsFactors = TRUE)
```
...
## -- CORE SURFACES --
# Load NK and TH data
load("../methods/data/derived_data/patchedNK.RData")
load("../methods/data/derived_data/patchedTH.RData")
...
## -- PREF SCARS --
# Load NK and TH data
load("../methods/data/derived_data/prefNK.RData")
load("../methods/data/derived_data/prefTH.RData")
...
load("../methods/data/derived_data/prod_patched.Rdata")
load("../methods/data/derived_data/prod_ventr.Rdata")
prods <- read.csv("../methods/data/derived_data/File_list_prods.csv")
...
core_links <- read.csv("../methods/data/derived_data/Core_links.csv")
...
pref_links <- read.csv("../methods/data/derived_data/Pref_links.csv")
...
prod_links <- read.csv("../methods/data/derived_data/Prod_links.csv")
...
pref_prod <- read.csv("../methods/data/derived_data/Pref_prod_list.csv")
